            ...
            <div class="complaintbox">
              ...
              <form action="" method="POST">
                ...
                <div class="input-box nochange">
                  <input type="text" name="from_email" value="<?php echo $row["student_email"]; ?>" readonly required>
                  <label>Your email</label>
                </div>

                <div class="input-box nochange">
                  <input type="text" required value="<?php echo $row["student_name"]; ?>" readonly name="name">
                  <label>Name</label>
                </div>
