            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <div class="user-profile">
                    <div class="user-image">
                        <img src="../Assets/Files/<?php echo $_SESSION["adminpic"]; ?>">
                    </div>
                    <div class="user-name">
                        <h6 class="font-weight-bold"><?php echo $_SESSION["adminname"]; ?></h6>
                    </div>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            ...
                            <li class="nav-item"> <a class="nav-link" href="Programme.php">Add Programme</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="auth">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="AssignTeacher.php">Assign Teacher</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-sm-12 mb-4 mb-xl-0">
                            <h4 class="font-weight-bold text-dark">Hi, welcome back <?php echo $_SESSION["adminname"]; ?>!</h4>
