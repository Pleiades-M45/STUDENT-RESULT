            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <div class="user-profile">
                    <div class="user-image">
                        <img src="../Assets/Files/<?php echo $_SESSION["teacherpic"]; ?>">
                    </div>
                    <div class="user-name">
                        <h6 class="font-weight-bold"><?php echo $_SESSION["teachername"]; ?></h6>
                    </div>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="ExamMark.php">Add Marks</a></li>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-sm-12 mb-4 mb-xl-0">
                            <h4 class="font-weight-bold text-dark">Hi, welcome back <?php echo $_SESSION["teachername"]; ?>!</h4>
