...
<body>
                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST" class="forms-sample">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-single w-100" name="student_id" id="sid" required>
                                <?php
                                $selQry = "SELECT * FROM tbl_student WHERE parent_id='" . $_SESSION["parentid"] . "'";
                                $data = mysqli_query($con, $selQry);
                                while ($row = mysqli_fetch_assoc($data)) {
                                ?>
    ...
    <script>
        function examcalc() {
            ...
            $.ajax({
                url: "../Assets/AjaxPages/AjaxParentResult.php?pid=" + pid + "&sid=" + sid,
