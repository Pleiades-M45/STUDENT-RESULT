...
if (isset($_POST["btn_submit"])) {
	...
	if ($current_password == $row["parent_password"]) {
		if ($new_password == $re_password) {
			$upQry = "UPDATE tbl_parent SET parent_password='$new_password' WHERE parent_id='" . $_SESSION["parentid"] . "'";
...
<head>
	...
	<title>Parent | ChangePassword</title>
